...
*   **Hidden Backdoor Detection**: Audits the filesystem for suspicious hidden files used for persistent web-shell access.

<p align="center">
  <img src="assets/forensics-preview.png" alt="Technical Forensics" width="700px" style="border-radius: 20px;">
</p>

### 2. Multimodal AI Interrogation
...
*   **Interrogative Chat**: A multi-turn AI protocol allowing operators to iteratively refine remediation scripts.

<p align="center">
  <img src="assets/ai-uplink-preview.png" alt="Intelligence Uplink" width="700px" style="border-radius: 20px;">
</p>
...
*   **[Request Forensic Signature](https://github.com/BrandenNaidoo/Companion-Sentinel-Public/issues/new?title=[Signature+Request]+)**: Request detection for a specific CVE or malware pattern.
